  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="max-w-(--breakpoint-lg) w-full py-10 px-6">
        <h2
          className="text-4xl md:text-[2.75rem] md:leading-[1.2] font-semibold tracking-[-0.03em] sm:max-w-xl text-pretty sm:mx-auto sm:text-center">
        ...
        <div className="mt-8 md:mt-16 w-full mx-auto space-y-20">
          {features.map((feature) => (
            <div
              ...
              <div
                className="w-full aspect-[4/3] bg-muted rounded-xl border border-border/50 basis-1/2" />
